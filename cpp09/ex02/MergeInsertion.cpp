...
std::vector<std::pair<int,int>> string_to_vector(std::string &str,int &last_int)
{
...
void print_vector(const std::vector<int> &alo)
{
 ...
 std::pair<std::vector<int>, std::vector<int>> create_w_a_l(std::vector<std::pair<int,int>> &alo)
 {
